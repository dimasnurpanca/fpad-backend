...
$banned = $conn->real_escape_string($_GET['banned']);
$sql = "UPDATE `users` SET `status`=0 WHERE id=$banned";
$result = $conn->query($sql);
echo "<script>alert('Berhasil dibanned!')</script>";
                          ...
                          <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                              ...
                              <?php foreach($list_users as $s){ ?>
                                                    <tr>
                                                          ...
                                                          <td align="center"><?php echo "<a href='users.php?banned=".$s['id']."' class='btn btn-warning'>Ban User</a>"; ?></td>
